...
teacher_ckpt = 'https://github.com/Mrxiaoyuer/coco_checkpoints/releases/download/v0.0.4/frcnn_r101_398.pth'  # noqa
...
#     samples_per_gpu=2,
#     workers_per_gpu=2,
#     train=dict(ann_file='data/mini_coco/' + 'annotations/instances_train2017.json'),
# )